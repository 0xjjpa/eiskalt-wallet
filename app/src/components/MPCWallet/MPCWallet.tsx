                ...
                <Flex justifyContent={"center"}>
                  ...
                  {storedKeyshare && (
                    <IconButton
                      ...
                      icon={<DownloadIcon />}
                      onClick={() => {
                        setKeyshare(JSON.parse(storedKeyshare));
                      }}
        ...
        {keyshare && (
          <Flex my="10" flexDir={"column"}>
            <MPCValue
              ...
              emoji="💻|📱"
              explanation={`We now have a shared keyshare able to jointly co-sign a payload
              for the given public address. Both shares are needed and one w/o the other
              are practically useless. Verify the public address matches your other device
              public address to be able to sign transactions together.`}
              description="MPC keyshare generated by both 💻 and 📱"
            />
            <Box mt="2">
              <MPCSign keyshare={keyshare} sessionId={id} instance={instance} channel={channel} />
            </Box>
          </Flex>
        )}
